...
adv_dataset_train_path = 'adv_dataset_3/train'
adv_dataset_test_path = 'adv_dataset_3/test'
...
def make_adv_captcha_train(epoch):
    net.eval()
    benign_correct = 0
...
def make_adv_captcha_test(epoch):
    net.eval()
    benign_correct = 0
    benign_filter_correct = 0
    adv_correct = 0
...
make_adv_captcha_train(0)
make_adv_captcha_test(0)
